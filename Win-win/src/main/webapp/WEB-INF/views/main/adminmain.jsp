	...
	<div class="row">
		<div class="col-4 mt-4" style="height: 280px; border-bottom: 1px solid lightgrey; border-right: 1px solid lightgrey;">
			...
			<ul>
				...
				<li class="mb-3" style="font-size: 14px">경력 PM 채용</li>
			</ul>
		</div>
		<div class="col-4 mt-4" style="height: 280px; border-bottom: 1px solid lightgrey; border-right: 1px solid lightgrey;">
			<div class="row">
			...
			<ul>
				...
				<li class="mb-3" style="font-size: 14px">2018 상반기 신입사원 채용 공지</li>
			</ul>
		...
		<div class="col-4 text-center mt-2">
			...
			<a href="#" style="text-decoration: none; color: black;"><button type="button" class="btn btn-secondary btn-sm mt-2" style="width: 300px">지원현황 바로가기</button></a>
		</div>
	</div>
	<div class="row">
