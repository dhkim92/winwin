		...
		<ul class="pagination">
			<c:if test="${paging.curPage eq 1 }">
				<li class="page-item disabled"><a class="page-link "
					href="/result/list" aria-label="Previous">&laquo;</a></li>
			</c:if>
			<c:if test="${paging.curPage ne 1 }">
				...
				<li><fmt:parseNumber var="p" integerOnly="true"
					...
					href="/result/list?curPage=${prevPage }" aria-label="Previous">
			...
			<c:if test="${paging.curPage eq paging.totalPage }">
				...
				<li class="disabled"><a class="page-link"
					href="/result/list?curPage=${paging.totalPage }" aria-label="Next">
			...
			<c:if test="${paging.curPage ne paging.totalPage }">
				...
				<li><a class="page-link"
					href="/result/list?curPage=${nextPage }" aria-label="Next"> <span
